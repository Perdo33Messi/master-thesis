...
class MPCDebugPlot:
    ...
    safe_areas = {
        ...
        'FrankaFetchPickDynFrontVStaticGrooveEnv-v1': [[0.05, 0.03], [0.05, 0.048], [0.05, 0.05]],

        # 【新场景 03 - 先静态的 U 形槽，后面是动态的方块】
        'FrankaFetchPickDynFrontUStaticGrooveEnv-v1': [[0.05, 0.03], [0.05, 0.048], [0.05, 0.05]],

        # 【新场景 04 - 前面是动态的方块，后静态的 V 形槽】
        'FrankaFetchPickDynRearVStaticGrooveEnv-v1': [[0.05, 0.03], [0.05, 0.048], [0.05, 0.05]],
    }
    ...
    obstacle_colors = {
        ...
        # 【新场景 02 - 先静态的 V 形槽，后面是动态的方块】
        'FrankaFetchPickDynFrontVStaticGrooveEnv-v1': ['#416ab6', '#5aa9a2'],

        # 【新场景 03 - 先静态的 U 形槽，后面是动态的方块】
        'FrankaFetchPickDynFrontUStaticGrooveEnv-v1': ['#416ab6', '#5aa9a2'],

        # 【新场景 04 - 前面是动态的方块，后静态的 V 形槽】
        'FrankaFetchPickDynRearVStaticGrooveEnv-v1': ['#416ab6', '#5aa9a2'],
